...
using Content.Shared._GoobStation.Weapons.Ranged.Components;
using Content.Shared.Power.Components;
using Content.Shared.Weapons.Ranged.Events;

namespace Content.Server._GoobStation.Mech.Equipment.EntitySystems;
public sealed class MechGunSystem : EntitySystem
{
    ...
    private void OnCheckBattery(EntityUid uid, AbstractBatteryAmmoProviderComponent component, CheckMechWeaponBatteryEvent args)
    {
    ...
    private void ChargeGunBattery(EntityUid uid, BatteryComponent component)
    {
        ...
        var LastCharge = component.LastCharge;

        var chargeDelta = maxCharge - LastCharge;
        ...
        _battery.SetCharge(uid, component.MaxCharge); // LP TWEAK
    }
}
